...
export default function Tred() {
    ...
    const [imagem, setImagem] = useState(null); // Estado para armazenar a textura carregada
    ...
    // Aqui você pode definir as dimensões do canvas
    const canvas = canvasRef.current;
    const renderer = new THREE.WebGLRenderer({ canvas, alpha: true }); // Set alpha to true for transparent background
    renderer.setSize(800, 500); // Define o tamanho do canvas
    ...
    useEffect(() => {
        ...
        textureLoader.load(
            ...
            (texture) => {
                ...
                setImagem(texture); // Define a textura carregada no estado
            },
            undefined,
            (error) => {
